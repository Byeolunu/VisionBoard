  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        systemInstruction: "You are BoardVision AI, an elite technical architect. Convert sketches to high-quality code and architectural diagrams. Always be precise, educational, and clean. For diagrams, use strict Mermaid.js flowchart syntax and quote all labels.",
      },
    });
